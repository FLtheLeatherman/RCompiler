...
public:
    ...
    Instruction* createGetElementPtr(Type* type, Value* ptr, size_t idx, bool need_0 = false);
    Instruction* createGetElementPtr(Type* type, Value* ptr, Value* idx, bool need_0 = false);
};
