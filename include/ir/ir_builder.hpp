...
public:
    ...
    Instruction* createGetElementPtr(Type* type, Type* pointee_type, Value* ptr, size_t idx);
    Instruction* createGetElementPtr(Type* type, Type* pointee_type, Value* ptr, Value* idx);
